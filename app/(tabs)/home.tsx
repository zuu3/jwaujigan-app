...
const styles = StyleSheet.create({
  ...
  streakBadge: { paddingHorizontal: spacing[3], paddingVertical: 4, borderRadius: 20, backgroundColor: '#fff3e0' },
  streakText: { ...typography.caption, color: '#e65100', fontWeight: '700' },
  title: { ...typography.displayLarge, color: colors.grey900 },
  cta: { alignSelf: 'flex-start', minHeight: 44, justifyContent: 'center', paddingHorizontal: spacing[4], borderRadius: 8, backgroundColor: colors.blue500 },
